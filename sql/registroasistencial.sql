...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-02-2019 a las 21:43:37
...
--
-- Base de datos: `registroasistencial`
--
...
--
-- Estructura de tabla para la tabla `dbcursos`
--

CREATE TABLE IF NOT EXISTS `dbcursos` (
`idcurso` int(11) NOT NULL,
  `descripcion` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  `codigo` varchar(10) COLLATE utf8_spanish_ci NOT NULL,
  `refsalones` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `dbdocentes`
--

CREATE TABLE IF NOT EXISTS `dbdocentes` (
...
(20, 'ropaldo daniela', '123456', 3, 'ropaldo@gmail.com', 'ropaldo daniela', b'0', 26);
...
(0, '../categorias/', 'filter_list', 'Categorias', 3, NULL, 'Administrador, Empleado', b'1', b'1', b'1', 0),
...
--
-- Indices de la tabla `dbcursos`
--
ALTER TABLE `dbcursos`
 ADD PRIMARY KEY (`idcurso`);

--
-- Indices de la tabla `dbdocentes`
--
ALTER TABLE `dbdocentes`
...
--
ALTER TABLE `dbactivacionusuarios`
MODIFY `idactivacionusuario` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT de la tabla `dbcursos`
--
ALTER TABLE `dbcursos`
MODIFY `idcurso` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `dbdocentes`
--
ALTER TABLE `dbdocentes`
